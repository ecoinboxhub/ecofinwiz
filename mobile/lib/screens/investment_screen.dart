...
class _InvestmentScreenState extends State<InvestmentScreen> {
  static const String _channel = 'investment';
  ...
  Future<void> _send() async {
    ...
    String streaming = '';
    try {
      await _api.stream('/ai/investment/chat', body: {'message': text}, onEvent: (event) {
        switch (event['event']) {
          case 'token':
            ...
            child: _messages.isEmpty
                ? Center(
                    child: Column(
                        ...
                        const Text("Hi! I'm Musa",
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: AppTheme.ink)),
                        const SizedBox(height: 8),
                        const Text('Your investment coach.',
                            style: TextStyle(color: AppTheme.muted)),
                        const SizedBox(height: 16),
                        ...['Best stocks to buy now?', 'What is diversification?',
        ...
        Container(
          ...
          child: Row(children: [
            Expanded(
              child: TextField(
                  ...
                  decoration: const InputDecoration(
                      hintText: 'Ask Musa...', isDense: true),
                  onSubmitted: (_) => _send()),
            ),
            ...
            IconButton.filled(
              ...
              style:
                  IconButton.styleFrom(backgroundColor: AppTheme.success),
            ),
          ]),
        ),
      ]),
